...
public class ALL_EXTENDED_LEFT_Event extends ParameterizableViatraQueryPatternEventInstance {
  public ALL_EXTENDED_LEFT_Event(final EventSource eventSource) {
    super(eventSource);
