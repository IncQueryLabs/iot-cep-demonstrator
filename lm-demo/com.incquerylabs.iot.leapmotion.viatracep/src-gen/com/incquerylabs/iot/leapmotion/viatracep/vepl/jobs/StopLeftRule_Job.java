...
public class StopLeftRule_Job extends CepJob<IObservableComplexEventPattern> {
  public StopLeftRule_Job(final ActivationState activationState) {
  ...
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    try {
      ...
      GestureUtils.INSTANCE.processGesture(ComplexGestures.ComplexGesture.Type.TYPE_STOP, t, 10);
    } catch (Throwable _e) {
