...
public class SpeedUpRightRule_Job extends CepJob<IObservableComplexEventPattern> {
  public SpeedUpRightRule_Job(final ActivationState activationState) {
  ...
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    try {
      ...
      GestureUtils.INSTANCE.processGesture(ComplexGestures.ComplexGesture.Type.TYPE_SPEED_UP, t, 9);
    } catch (Throwable _e) {
