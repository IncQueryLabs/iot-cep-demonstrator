...
public class SlowDownRightRule_Job extends CepJob<IObservableComplexEventPattern> {
  public SlowDownRightRule_Job(final ActivationState activationState) {
  ...
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    try {
      ...
      GestureUtils.INSTANCE.processGesture(ComplexGestures.ComplexGesture.Type.TYPE_SLOW_DOWN, t, 9);
    } catch (Throwable _e) {
