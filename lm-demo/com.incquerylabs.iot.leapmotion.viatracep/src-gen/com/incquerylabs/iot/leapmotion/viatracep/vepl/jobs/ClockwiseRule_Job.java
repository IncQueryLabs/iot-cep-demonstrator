...
public class ClockwiseRule_Job extends CepJob<IObservableComplexEventPattern> {
  public ClockwiseRule_Job(final ActivationState activationState) {
    super(activationState);
  }
  
  @Override
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    InputOutput.<String>println("CLOCKWISE ROLL");
  }
