...
public class SpeedUpLeftRule_Job extends CepJob<IObservableComplexEventPattern> {
  public SpeedUpLeftRule_Job(final ActivationState activationState) {
  ...
  public void execute(final Activation<? extends IObservableComplexEventPattern> ruleInstance, final Context context) {
    try {
      ...
      GestureUtils.INSTANCE.processGesture(ComplexGestures.ComplexGesture.Type.TYPE_SPEED_UP, t, 10);
    } catch (Throwable _e) {
